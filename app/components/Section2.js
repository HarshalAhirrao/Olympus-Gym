        ...
        <section id="about" className="w-full px-6 md:px-20 py-16 bg-white text-black">
            ...
            <div className="flex flex-wrap justify-center items-center gap-3 mt-10">
                {[
                    ...
                    <div
                        key={index}
                        className="card flex justify-center flex-col items-center rounded-lg shadow-md transition-transform duration-300 hover:-translate-y-2 hover:shadow-lg min-h-[300px] w-[75vw] md:min-w-[250px] md:max-w-[300px] md:w-[24%] bg-[#efefef] cursor-pointer">
                        <Image src="/img/spartan.png" alt="Olympus Logo" width={40} height={40} className="invert mt-[20px] mb-[30px]" />
                        <h1 className="text-black text-lg mb-[15px]">{item.title}</h1>
                        <h1 className="text-[#767378] text-center text-md font-[14px] px-4 mb-4 tracking-wide">{item.text}</h1>
                    </div>
                ))}
            </div>
        </section>
