            ...
            <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-14">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="md:w-1/2 text-center md:text-left">
                    ...
                    <p className="text-gray-400 text-sm md:text-base mb-6 leading-relaxed">
                        Olympus isn’t just another online gym — it's a movement. Our mission is to deliver transformative, accessible fitness experiences through expert-led online training. Whether
                        you're just starting or leveling up, we’re here to fuel your evolution.
                    </p>
