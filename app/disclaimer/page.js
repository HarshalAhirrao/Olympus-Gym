                ...
                <div className="rounded-2xl p-[1px] bg-gradient-to-b from-white/10 to-transparent">
                    <div className="bg-[#0f0f0f] rounded-2xl p-8 space-y-4">
                        <p className="text-gray-400 text-sm leading-7">
                            Olympus Gym is not a real business. This website was created for educational and portfolio purposes. All content, pricing, and contact features are for demonstration only.
                        </p>
                        <p className="text-gray-500 text-xs italic">If you reached this site via search, please note no actual services are being offered.</p>
                    </div>
                </div>
            </div>
        </main>
